...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, waypoint):
        ...
        acceleration = self._lon_controller.run_step(self._last_vehicle_state, target_speed)
        current_steering = self._lat_controller.run_step(self._last_vehicle_state, waypoint)
